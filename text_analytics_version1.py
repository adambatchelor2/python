...
#str_to_test = "Too small. Food options lacking. Only drinks behind unstaffed bar. Disappointed" #0.04 old method - -0.35 new lrd100021
...
str_to_test = "Food is extremely limited & not at all appetising, stale sandwiches, 2 types of pastries thats pretty much it & very poor. Staff on the front desk was miserable without even a Hello on entering, although did smile & was trying to be nice when asking us to fill a questionnaire in on our experience. Not really worth the reduced fee when using the pass so definitely not worth the full entry fee." #0.07 old method - 0.089 new lrd100027
#str_to_test = "Best lounge I have used in the UK, this lounge is the reason I keep the Priority Pass." #0.86 old method - 1 new lrd100012
