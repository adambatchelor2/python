...
pytrends = TrendReq(hl='en-gb', requests_args={'verify':False})

KEYWORDS='Travel'

print(pytrends.suggestions(KEYWORDS))

# KEYWORDS_CODES=[pytrends.suggestions(keyword=i)[0] for i in KEYWORDS]
